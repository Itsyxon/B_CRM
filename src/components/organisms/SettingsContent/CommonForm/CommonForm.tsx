...
const CommonForm = () => {
    return (
        <form className='mt-4 flex flex-col gap-4'>
            ...
            <p className='text-sm text-[var(--secondary)]'><Link className='text-blue-400 font-semibold underline underline-offset-4' href='/dashboard'>Свяжитесь</Link> с тех. поддержкой, чтобы запросить создание собственного виджета</p>
            <Divider />
